...
"$build_dir/bin/hab-pkg-deb" --testname noopts core/busybox
...
echo 'Test setup for cli_provides_section: provide section via CLI'
"$build_dir/bin/hab-pkg-deb" --testname "cli_override_section" --section tuba core/busybox
...
"$build_dir/bin/hab-pkg-deb" --testname pkg_provides_upstream_url core/netcat
